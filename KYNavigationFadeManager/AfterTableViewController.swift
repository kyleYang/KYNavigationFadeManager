...
open class AfterTableViewController: UIViewController {
    ...
    override open func viewDidLoad() {
        ...
        searchBarView = CustomSearchBarView(frame: CGRect(x: 0, y: 0, width: self.view.bounds.width, height: 44))
        ...
        let shareBarItem = UIBarButtonItem(image: UIImage(named:"lx_common_share")?.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(AfterTableViewController.buttonTapped(sender:)))
